...
#[derive(Debug)]
pub struct SecretNetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SecretNetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SecretNet processing");
    
    let mut processor = SecretNetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SecretNetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SecretNetProcessor::new(false);
